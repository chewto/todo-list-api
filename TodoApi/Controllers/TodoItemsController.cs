...
namespace TodoApi.Controllers
{
    ...
    public class TodoItemsController : ControllerBase
    {
        ...
        //puedes usar patch para hacer actualizaciones parciales
        [HttpPut("{id}")]
        public async Task<IActionResult> PutTodoItem(long id, TodoItemDTO todoDTO)
        {
            ...
            var todoI = await _context.TodoItem.FindAsync(id);
            ...
            todoI.Name = todoDTO.Name;
            todoI.IsComplete = todoDTO.IsComplete;
